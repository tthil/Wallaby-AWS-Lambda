...
This project contains source code and supporting files for a serverless application that you can deploy with the AWS Serverless Application Model (AWS SAM) command line interface (CLI). It's integrated with the WallabyJS testing tools and framework. 
...
```bash
aws cloudformation delete-stack --stack-name Wallaby-AWS-Lambda
```
